-- https://cata-twinhead.twinstar.cz/?npc=30464
...
(15,10144,0,0,16,1101,0,0,0,'','Show the gossip if the player is from the alliance', 0),
...
(15,10144,1,0,16,690,0,0,0,'','Show the gossip if the player is from the horde', 0),
