...
typedef std::unordered_map<uint32, ResearchSiteInfo> ResearchSiteInfoMap;
...
class ObjectMgr
{
    ...
    public:
        ...
        typedef std::unordered_map<uint32, RewardOnKillEntry> RewOnKillMap;
    ...
    private:
        ...
        typedef std::unordered_map<uint32, std::set<uint32> > ObjectQuestRelationCache;
