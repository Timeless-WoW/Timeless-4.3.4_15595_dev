...
enum SMART_ACTION
{
    ...
    SMART_ACTION_SET_ROOT                           = 103,    // NYI
    SMART_ACTION_SET_GO_FLAG                        = 104,    // NYI
    SMART_ACTION_ADD_GO_FLAG                        = 105,    // NYI
    SMART_ACTION_REMOVE_GO_FLAG                     = 106,    // NYI
    SMART_ACTION_SUMMON_CREATURE_GROUP              = 107,    // NYI
    SMART_ACTION_SET_POWER                          = 108,    // NYI
    SMART_ACTION_ADD_POWER                          = 109,    // NYI
    SMART_ACTION_REMOVE_POWER                       = 110,    // NYI
    SMART_ACTION_GAME_EVENT_STOP                    = 111,    // NYI
    SMART_ACTION_GAME_EVENT_START                   = 112,    // NYI
    SMART_ACTION_START_CLOSEST_WAYPOINT             = 113,    // NYI
    SMART_ACTION_MOVE_OFFSET                        = 114,    // PointId (Is better that MOVE_FOWARD, movement via target fields x, y, z.)
    SMART_ACTION_RANDOM_SOUND                       = 115,    // NYI
    SMART_ACTION_SET_CORPSE_DELAY                   = 116,    // NYI
    SMART_ACTION_DISABLE_EVADE                      = 117,    // NYI
    SMART_ACTION_GO_SET_GO_STATE                    = 118,    // NYI
    SMART_ACTION_SET_CAN_FLY                        = 119,    // NYI
    SMART_ACTION_REMOVE_AURAS_BY_TYPE               = 120,    // NYI
    SMART_ACTION_SET_SIGHT_DIST                     = 121,    // NYI
    SMART_ACTION_FLEE                               = 122,    // NYI
    SMART_ACTION_ADD_THREAT                         = 123,    // NYI
    SMART_ACTION_LOAD_EQUIPMENT                     = 124,    // NYI
    SMART_ACTION_TRIGGER_RANDOM_TIMED_EVENT         = 125,    // NYI
    SMART_ACTION_REMOVE_ALL_GAMEOBJECTS             = 126,    // NYI
    SMART_ACTION_PAUSE_MOVEMENT                     = 127,    // NYI
    SMART_ACTION_PLAY_ANIMKIT                       = 128,    // NYI
    SMART_ACTION_SCENE_PLAY                         = 129,    // NYI
    SMART_ACTION_SCENE_CANCEL                       = 130,    // NYI
    SMART_ACTION_SPAWN_SPAWNGROUP                   = 131,    // NYI
    SMART_ACTION_DESPAWN_SPAWNGROUP                 = 132,    // NYI
    SMART_ACTION_RESPAWN_BY_SPAWNID                 = 133,    // NYI
    SMART_ACTION_INVOKER_CAST_                      = 134,    // NYI
    SMART_ACTION_PLAY_CINEMATIC                     = 135,    // NYI
    SMART_ACTION_SET_MOVEMENT_SPEED                 = 136,    // NYI
    SMART_ACTION_PLAY_SPELL_VISUAL_KIT              = 137,    // NYI
    SMART_ACTION_OVERRIDE_LIGHT                     = 138,    // NYI
    SMART_ACTION_OVERRIDE_WEATHER                   = 139,    // NYI
    SMART_ACTION_SET_AI_ANIM_KIT                    = 140,    // NYI
    SMART_ACTION_SET_HOVER                          = 141,    // NYI
    SMART_ACTION_SET_HEALTH_PCT                     = 142,    // NYI
    SMART_ACTION_CREATE_CONVERSATION                = 143,    // NYI
    SMART_ACTION_SET_IMMUNE_PC                      = 144,    // NYI
    SMART_ACTION_SET_IMMUNE_NPC                     = 145,    // NYI
    SMART_ACTION_SET_UNINTERACTIBLE                 = 146,    // NYI
    SMART_ACTION_ACTIVATE_GAMEOBJECT                = 147,    // NYI
    SMART_ACTION_ADD_TO_STORED_TARGET_LIST          = 148,    // NYI
    SMART_ACTION_BECOME_PERSONAL_CLONE_FOR_PLAYER   = 149,    // NYI
    SMART_ACTION_TRIGGER_GAME_EVENT                 = 150,    // NYI
    SMART_ACTION_DO_ACTION                          = 151,    // NYI
    SMART_ACTION_COMPLETE_QUEST                     = 152,    // NYI
    SMART_ACTION_CREDIT_QUEST_OBJECTIVE_TALK_TO     = 153,    // NYI
